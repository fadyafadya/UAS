...
tah = st.sidebar.number_input("Banyak negara", min_value=1, max_value=None)
tah2 = st.sidebar.number_input("Pilih tahun *1971--2015", min_value=1971, max_value=2015, value=1971)
...
tah3 = st.sidebar.number_input("Pilih tahun *1971--2015", min_value=1971, max_value=2015, value=1971)
