...
tah2 = st.sidebar.number_input("Pilih tahun *1971--2015", min_value=1971, max_value=2015)
...
tah3 = st.sidebar.number_input("Pilih tahun *1971-2015", min_value=1971, max_value=2015)
